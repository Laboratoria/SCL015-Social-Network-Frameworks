...
Ver [scl015-social-network](https://github.com/Laboratoria/SCL015-Social-Network#5-criterios-de-aceptaci%C3%B3n-m%C3%ADnimos-del-proyecto).

## 6. Hacker edition

Ver [scl015-social-network](https://github.com/Laboratoria/SCL015-Social-Network#6-hacker-edition).
